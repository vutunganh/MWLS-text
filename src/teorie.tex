...
\begin{algorithm}[ht!]
  ...
  \begin{algorithmic}
    ...
    \Ensure $M \subseteq S$
    \Procedure{NaiveSearch}{$S, q, \delta$}
  ...
  \begin{algorithmic}
    ...
    \Procedure{KdSearch}{kořen k-d stromu $V$, $q \in \reals^k, \delta \in \reals$}
      \If{$L(V) = \emptyset \land R(V) = \emptyset$}
        \State \Return \Call{NaiveSearch}{$S(V)$}
      \EndIf
